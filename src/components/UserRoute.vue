  ...
  >
    ...
    >
      ...
      >
        ...
        <p class="text-xs mb-5">
          <span><i class="fas fa-user text-black mr-3"></i> </span> User Account
        </p>
        <p
          @click="edit()"
    ...
    <div
      class="flex flex-col h-fit w-full relative"
    ...
    >
      ...
      >
        ...
        >
          ...
          <p class="text-lg font-bold tracking-wide">Transactions:</p>
          <div class="flex flex-col my-3 relative w-full">
            <table>
              <tr
                class="
                  flex
          ...
          <div class="flex relative mt-auto items-end w-36">
            <button
              class="
                ...
                py-2
                px-3
                hover:tracking-wider hover:bg-white hover:text-black
                btn-border
                text-white
              "
            >
        ...
        >
          <div class="text-center">
            ...
            <p class="text-gray-400 dark:text-gray-400">
              Fill up the form below to send us a feedback.
            </p>
          </div>
          <div class="m-7">
            <form>
              <div class="mb-6">
                <label
                  for="name"
                  class="block mb-1 text-sm text-gray-600 dark:text-gray-400"
                  >Full Name</label
                >
                <input
                  type="text"
    ...
    <div
      v-if="$store.state.makeDonations"
      class="card-div flex w-full justify-between h-1/2"
    >
      <div
        class="
