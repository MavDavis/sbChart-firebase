<template>
  <div
    ...
    class="app overflow-hidden h-full w-full relative bg-gray-800"
  >
    <div
      class="h-full relative py-5 md:pl-0 pl-5 pr-5 flex flex-col justify-center"
    >
      <div
        @click="
          $store.state.mobileScreenOpened = !$store.state.mobileScreenOpened
        "
        v-if="$store.state.mobileScreen"
        class="flex justify-end items-center h-9 w-full p-5"
      >
        <i
